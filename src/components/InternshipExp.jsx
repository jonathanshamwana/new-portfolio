...
const SiphoxContent = () => (
    <>
        ...
        <div className="relative mx-auto" style={{ paddingBottom: '46.875%', height: 0, maxWidth: '75%' }}>
            <iframe
                title="SiPhox internship walkthrough"
...
const GoogleContent = () => (
    <div className="max-w-3xl mx-auto text-center py-16 mb-20">
        <p className="text-lg mb-4">
            <b>Work in progress.</b>
        </p>
        <p className="text-lg text-gray-600">
            My write-up on my time at Google is coming soon. Check back shortly.
        </p>
    </div>
);

const InternshipExperience = () => {
    const [activeTab, setActiveTab] = useState('siphox');
    ...
    return (
        <section id="internships" className="pt-12 pb-14 bg-site">
            ...
            <div className="container mx-auto px-10">
                ...
                <div className="internship-tabs" role="tablist" aria-label="Internship experiences">
                    <span
                        className="internship-tab-indicator"
                    ...
                    {TABS.map((tab) => (
                        <button
                            ...
                            className={`internship-tab ${activeTab === tab.key ? 'is-active' : ''}`}
                ...
                <div key={activeTab} className="internship-panel">
                    {activeTab === 'siphox' ? <SiphoxContent /> : <GoogleContent />}
                </div>
            </div>
        </section>
    );
